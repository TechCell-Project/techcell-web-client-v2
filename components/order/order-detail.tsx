    ...
    <div className="container py-4">
      <div className="w-full">
        <div className="w-full sm:w-[600px] m-auto h-auto bg-white rounded-md">
          <div className="py-4">
            <div className="w-full text-center">Chi tiết đơn hàng</div>
            {/* Thông tin khách hàng */}
            <div className="w-full p-5 ">
              <ul className="w-full text-left">
                <li className="w-full flex justify-between items-center mb-2">
                  <div>Mã đơn hàng:</div>
                  <span className="font-bold">#29881</span>
                </li>
                <li className="w-full flex justify-between items-center  mb-2">
                  <div>Ngày đặt hàng:</div>
                  <span className="font-bold">05/05/2024</span>
                </li>
                <li className="w-full flex justify-between items-center  mb-2">
                  <div>Tình trạng:</div>
                  <span className="text-[#339901] font-bold">Đang xử lý</span>
                </li>
                <li className="w-full flex justify-between items-center  mb-2">
                  <div>Tên khách hàng:</div>
                  <span className="font-bold">Đặng Xuân Tiến</span>
                </li>
                <li className="w-full flex justify-between items-center  mb-2">
                ...
                <li className="w-full flex justify-between items-center  mb-2">
                  <div>Email:</div>
                  <span className="font-bold">asd@gmail.com</span>
                </li>
              </ul>
            </div>
            ...
            <div className="w-full p-5">
              <ul className="w-full text-left">
                ...
                <li className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-[#339901] font-bold">Đang chờ xử lý</span>
                </li>
              </ul>
            </div>
            <div className="border mx-5"></div>
            ...
            {/* BTN  */}
            <div className='w-full p-5'>
                <Button className='w-full'>Quay lại danh sách đơn hàng</Button>
            </div>
          </div>
        </div>
      </div>
